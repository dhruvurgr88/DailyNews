...
public partial class DailyNewsDbContext : DbContext
{
    ...
    public DbSet<View> ArticleViews { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SubscriptionId).HasName("PK__Subscrip__9A2B249DF93D843F");
            ...
            entity.Property(e => e.UserEmailId).HasMaxLength(200);

            entity.HasOne(d => d.UserEmail).WithMany(p => p.Subscriptions)
                .HasForeignKey(d => d.UserEmailId)
                .HasConstraintName("FK__Subscript__UserE__5070F446");
        });
